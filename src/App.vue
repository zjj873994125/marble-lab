...
onMounted(() => { window.addEventListener('resize', resizeViewport); window.addEventListener('orientationchange', resizeViewport); window.visualViewport?.addEventListener('resize', resizeViewport); coarsePointer.addEventListener('change', resizeViewport) })
onBeforeUnmount(() => { setTouchInput(emptyInput()); window.removeEventListener('resize', resizeViewport); window.removeEventListener('orientationchange', resizeViewport); window.visualViewport?.removeEventListener('resize', resizeViewport); coarsePointer.removeEventListener('change', resizeViewport) })
